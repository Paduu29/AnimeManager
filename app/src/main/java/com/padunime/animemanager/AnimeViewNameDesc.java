...
public class AnimeViewNameDesc extends AppCompatActivity implements AnimeAdapter.OnItemClickListener {
    ...
    public static Context contextAnimeView;


    public void getAnimeListView() throws IOException{
        DatabaseHelper mDatabaseHelper = new DatabaseHelper(this);
        ArrayList<ArrayList<String>> mArrayList= mDatabaseHelper.getAnimeSorted("title", "desc");
        ...
        mAnimeAdapter = new AnimeAdapter(AnimeViewNameDesc.this, mAnimeList);
        mRecylcerView.setAdapter(mAnimeAdapter);
        mAnimeAdapter.setOnItemClickListener(AnimeViewNameDesc.this);
    }
    ...
    public boolean onCreateOptionsMenu(Menu main_menu) {
        ...
        MenuItem item = main_menu.findItem(R.id.sort_name_desc);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.sort_name_asc:
                Intent intentViewNameAsc = new Intent(AnimeViewNameDesc.this, AnimeViewNameAsc.class);
                startActivity(intentViewNameAsc);
                finish();
                return true;

            case R.id.default_sort:
                Intent intentViewDefault = new Intent(AnimeViewNameDesc.this, AnimeViewActivity.class);
            ...
            case R.id.sort_score_asc:
                Intent intentViewScoreAsc = new Intent(AnimeViewNameDesc.this, AnimeViewScoreAsc.class);
                startActivity(intentViewScoreAsc);
                finish();
                return true;

            case R.id.sort_score_desc:
                Intent intentViewScoreDesc = new Intent(AnimeViewNameDesc.this, AnimeViewScoreDesc.class);
            ...
            case R.id.settings_option:
                //
                Intent intentSettings = new Intent(AnimeViewNameDesc.this, SettingsActivity.class);
            ...
            case R.id.logout_option:
                ...
                Intent i = new Intent(AnimeViewNameDesc.this, MainActivity.class);
                startActivity(i);
                finish();
                return true;
    ...
    public void onItemClick(int position) {
        ...
        contextAnimeView = this.getApplicationContext();
