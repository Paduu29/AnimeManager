...
public class AnimeViewScoreAsc extends AppCompatActivity implements AnimeAdapter.OnItemClickListener {
    ...
    public void getAnimeListView() throws IOException {
        ...
        ArrayList<ArrayList<String>> mArrayList= mDatabaseHelper.getAnimeSorted("score", "asc");
        ...
        mAnimeAdapter = new AnimeAdapter(AnimeViewScoreAsc.this, mAnimeList);
        mRecylcerView.setAdapter(mAnimeAdapter);
        mAnimeAdapter.setOnItemClickListener(AnimeViewScoreAsc.this);
    }
    ...
    public boolean onCreateOptionsMenu(Menu main_menu) {
        ...
        MenuItem item = main_menu.findItem(R.id.sort_score_asc);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.my_animes_option:
                Intent intentView = new Intent(AnimeViewScoreAsc.this, AnimeViewUser.class);
            ...
            case R.id.default_sort:
                Intent intentViewDefault = new Intent(AnimeViewScoreAsc.this, AnimeViewActivity.class);
            ...
            case R.id.settings_option:
                //
                Intent intentSettings = new Intent(AnimeViewScoreAsc.this, SettingsActivity.class);
            ...
            case R.id.logout_option:
                ...
                Intent i = new Intent(AnimeViewScoreAsc.this, MainActivity.class);
                startActivity(i);
                finish();
                return true;
