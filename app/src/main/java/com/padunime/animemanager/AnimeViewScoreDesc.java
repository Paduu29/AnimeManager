...
public class AnimeViewScoreDesc extends AppCompatActivity implements AnimeAdapter.OnItemClickListener {
    ...
    public void getAnimeListView() throws IOException {
        ...
        ArrayList<ArrayList<String>> mArrayList= mDatabaseHelper.getAnimeSorted("score", "desc");
        ...
        mAnimeAdapter = new AnimeAdapter(AnimeViewScoreDesc.this, mAnimeList);
        mRecylcerView.setAdapter(mAnimeAdapter);
        mAnimeAdapter.setOnItemClickListener(AnimeViewScoreDesc.this);
    }
    ...
    public boolean onCreateOptionsMenu(Menu main_menu) {
        ...
        MenuItem item = main_menu.findItem(R.id.sort_score_desc);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.my_animes_option:
                Intent intentView = new Intent(AnimeViewScoreDesc.this, AnimeViewUser.class);
                startActivity(intentView);
                return true;

            case R.id.sort_name_asc:
                Intent intentViewNameAsc = new Intent(this, AnimeViewNameAsc.class);
            ...
            case R.id.default_sort:
                Intent intentViewDefault = new Intent(AnimeViewScoreDesc.this, AnimeViewActivity.class);
            ...
            case R.id.settings_option:
                //
                Intent intentSettings = new Intent(AnimeViewScoreDesc.this, SettingsActivity.class);
            ...
            case R.id.logout_option:
                ...
                Intent i = new Intent(AnimeViewScoreDesc.this, MainActivity.class);
                startActivity(i);
                finish();
                return true;
